                                            ...
                                            <fieldset class="form-fieldset">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="position" required>
                                                        <option value="Admin" <?php echo ($open_information_employee_data['position'] == 'Admin') ? 'selected' : ''; ?>>Admin</option>
                                                        <option value="Staff" <?php echo ($open_information_employee_data['position'] == 'Staff') ? 'selected' : ''; ?>>Staff</option>
                                                        <option value="Guard" <?php echo ($open_information_employee_data['position'] == 'Guard') ? 'selected' : ''; ?>>Guard</option>
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="first_name" value="<?php echo $open_information_employee_data['first_name']; ?>" required/>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="middle_name" value="<?php echo $open_information_employee_data['middle_name']; ?>"  required/>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="last_name" value="<?php echo $open_information_employee_data['last_name']; ?>" required/>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="gender" required>
                                                        <option value="Male" <?php echo ($open_information_employee_data['gender'] == 'Male') ? 'selected' : ''; ?>>Male</option>
                                                        <option value="Female" <?php echo ($open_information_employee_data['gender'] == 'Female') ? 'selected' : ''; ?>>Female</option>
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" name="date_hired" value="<?php echo $open_information_employee_data['date_hired']; ?>"  required/>
